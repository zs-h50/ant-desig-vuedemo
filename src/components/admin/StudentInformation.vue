			...
			<a-modal
				...
				<a-form-model :form="upform" :label-col="{ span: 5 }" :wrapper-col="{ span: 12 }" @submit="editSubmit">
					...
					<a-form-item label="学号">
						<a-input v-model:value="upform.sNo" v-decorator="['sNo', { rules: [{ required: true, message: '学生学号不能为空' }] }]" placeholder="请输入学生的学号" />
					</a-form-item>
					...
					<a-form-item label="联系方式">
						<a-input v-model:value="upform.sPhone" v-decorator="['sPhone', { rules: [{ required: true, message: '学生联系方式不能为空' }] }]" placeholder="请输入学生的联系方式" />
					</a-form-item>
					<a-form-item label="邮箱">
						<a-input v-model:value="upform.email" v-decorator="['email', { rules: [{ required: true, message: '学生邮箱不能为空' }] }]" placeholder="请输入学生的邮箱方式" />
					</a-form-item>
					<!-- 出生日期 -->
					...
					<a-form-item label="身份证号">
						<a-input v-model:value="upform.idCard" v-decorator="['idCard', { rules: [{ required: true, message: '学生身份证号不能为空' }] }]" placeholder="请输入学生的身份证号" />
					</a-form-item>
					...
					<a-form-item label="联系人方式">
						<a-input v-model:value="upform.contactphone" v-decorator="['contactphone', { rules: [{ required: true, message: '学生联系人方式不能为空' }] }]" placeholder="请输入学生的联系人方式" />
					</a-form-item>
					...
					<a-form-item label="邮编">
						<a-input v-model:value="upform.postcode" v-decorator="['postcode', { rules: [{ required: true, message: '学生邮编不能为空' }] }]" placeholder="请输入学生的邮编" />
					</a-form-item>
					...
					<a-form-item label="父亲电话">
						<a-input v-model:value="upform.fatherphone" v-decorator="['fatherphone', { rules: [{ required: false, message: '学生父亲电话不能为空' }] }]" placeholder="请输入学生的父亲电话" />
					</a-form-item>
					...
					<a-form-item label="母亲电话">
						<a-input v-model:value="upform.matherphone" v-decorator="['matherphone', { rules: [{ required: false, message: '学生母亲电话不能为空' }] }]" placeholder="请输入学生的母亲电话" />
					</a-form-item>
